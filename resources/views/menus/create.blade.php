                        ...
                        <form method="post" action="{{ route('menus.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description" id="menu-description" cols="30" rows="10" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" placeholder="{{ __('Menu Descritpion') }}" required autofocus>
                                        {{ old('description') }}
                                    </textarea>
