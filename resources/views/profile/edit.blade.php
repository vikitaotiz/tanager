                    ...
                    <div class="col-md-4">
                        <div class="card card-user">
                            <div class="card-image">
                                <img src="{{asset('tanager/images/about_us.jpg')}}" alt="...">
                            </div>
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        <img class="avatar border-gray" src="{{asset('tanager/images/user.png')}}" alt="...">
                                ...
                                <p class="description text-center">
                                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Impedit assumenda adipisci eveniet ipsum corporis, alias voluptate unde? Suscipit velit debitis quos cum laborum quis? Libero doloribus numquam odit nulla tempore.
                                </p>
                            </div>
                            <hr>
