@extends('layouts/app', ['activePage' => 'login', 'title' => 'Tanager'])



@section('content')
    <div class="full-page section-image" data-color="black" style="background: #02001B;">
        <div class="content pt-5" style="background: #02001B;">
